...
#       \   /
#        __
testthat::test_that("'classify_points2' - (1 cross section, VALID (relief=T, banks=T)) - left_bank above bottm, flat left channel, flat bottom, flat right channel, and right_bank above bottom", {
  ID_COL <- "hy_id"
...
#    \   /
#      _
testthat::test_that("'classify_points2' - (1 cross section, 3 pts, VALID (relief=T, banks=T)) - 3 point 'V' shaped cross section", {
...
#    \   /
#      _
testthat::test_that("'classify_points2' - (1 cross section, 5 pts, 'V' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 1 BOTTOM -> 1 CHAN -> 1 RB", {
...
#    \    /
#      __
testthat::test_that("'classify_points2' - (1 cross section, 6 pts, 'V' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 2 BOTTOM -> 1 CHAN -> 1 RB", {
...
#    \     /
#      ___
testthat::test_that("'classify_points2' - (1 cross section, 7 pts, 'V' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 3 BOTTOM -> 1 CHAN -> 1 RB", {
...
#    \     /
#      ___
testthat::test_that("'classify_points2' - (1 cross section, 8 pts, 'V' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 4 BOTTOM -> 1 CHAN -> 1 RB", {
...
#    \     /
#      ___
testthat::test_that("'classify_points2' - (1 cross section, 9 pts, 'V' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 5 BOTTOM -> 1 CHAN -> 1 RB", {
...
#    \      /
#      ____
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'V' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 6 BOTTOM -> 1 CHAN -> 1 RB", {
...
# NOTE: Cross section shape:
#   \_______________/
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'WIDE U' shape, VALID (relief=T, banks=T)) - 1 LB -> 2 CHAN -> 4 BOTTOM -> 2 CHAN -> 1 RB", {
...
#                     /
#   \_______________/
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'WIDE U, HIGH RB' shape, VALID (relief=T, banks=T)) - 1 LB -> 2 CHAN -> 4 BOTTOM -> 2 CHAN -> 1 RB", {
...
#   \                  
#    \_______________/
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'WIDE U, HIGH LB' shape, VALID (relief=T, banks=T)) - 1 LB -> 2 CHAN -> 4 BOTTOM -> 2 CHAN -> 1 RB", {
...
#    \      /
#      ____
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'V + lips' shape, VALID (relief=T, banks=T)) - 2 LB -> 2 CHAN -> 2 BOTTOM -> 3 CHAN -> 1 RB", {
...
#       \      /
#         ____
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'V + breaks in both channel' shape, VALID (relief=T, banks=T)) - 1 LB -> 3 CHAN -> 2 BOTTOM -> 3 CHAN -> 1 RB", {
...
#       \      /
#         ____
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'V + breaks in LEFT side of channel' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 6 BOTTOM -> 1 CHAN -> 1 RB", {
...
#       \      /
#         ____
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'V + breaks in RIGHT side of channel' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 6 BOTTOM -> 1 CHAN -> 1 RB", {
...
#    \     /
#      ---
testthat::test_that("'classify_points2' - (1 cross section, 16 pts, 'V on left side' shape, VALID (relief=T, banks=T)) - 1 LB -> 1 CHAN -> 6 BOTTOM -> 1 CHAN -> 1 RB", {
  ...
  cpts <- classify_points2(cs, crosswalk_id = ID_COL)
  # cpts_rev <- classify_points2(cs_rev, crosswalk_id = ID_COL)
...
#               \
#                \
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, INVALID (relief=T, banks=F)) - left bank ABOVE bottom, bottom is FLAT, and right bank is BELOW bottom", {
  ID_COL       <- "hy_id"
  NUM_CS_PTS   <- 10
  CS_LENGTH    <- 100
  REL_DIST     <- seq(0, 1, length.out=NUM_CS_PTS+1)[2:(NUM_CS_PTS+1)]
...
# NOTE: Cross section shape:
# --------------------
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'flat line', INVALID (relief=F, banks=F)) - flat line", {
  ID_COL       <- "hy_id"
  NUM_CS_PTS   <- 10
  CS_LENGTH    <- 100
  REL_DIST     <- seq(0, 1, length.out=NUM_CS_PTS+1)[2:(NUM_CS_PTS+1)]
...
#                      /
# --------------------
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'flat line w/ RIGHT BANK', INVALID (relief=T, banks=F)) - flat line", {
  ID_COL       <- "hy_id"
  NUM_CS_PTS   <- 10
  CS_LENGTH    <- 100
  REL_DIST     <- seq(0, 1, length.out=NUM_CS_PTS+1)[2:(NUM_CS_PTS+1)]
...
# \                    
#  --------------------
testthat::test_that("'classify_points2' - (1 cross section, 10 pts, 'flat line w/ LEFT BANK', INVALID (relief=T, banks=F)) - flat line", {
  ID_COL       <- "hy_id"
  NUM_CS_PTS   <- 10
  CS_LENGTH    <- 100
  REL_DIST     <- seq(0, 1, length.out=NUM_CS_PTS+1)[2:(NUM_CS_PTS+1)]
...
testthat::test_that("'classify_points2' - (2 cross section, both VALID (relief=T, banks=T)) - left_bank above bottm, flat left channel, flat bottom, flat right channel, and right_bank above bottom", {
  ID_COL <- "hy_id"
