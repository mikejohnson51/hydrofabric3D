...
# -------------------------------------------------------------------
# ---- hydrofabric3D::get_transect_extension_distances_to_polygons() ----
# -------------------------------------------------------------------
testthat::test_that("get_transect_extension_distances_to_polygons() correct output columns - default inputs", {
  # transect_lines, 
  # polygons, 
  # flowlines, 
  # crosswalk_id = 'hy_id',  
  ...
  ext_dists <- get_transect_extension_distances_to_polygons(
    transects = transects,
    polygons = polygons, 
    crosswalk_id = CROSSWALK_ID, 
...
testthat::test_that("get_transect_extension_distances_to_polygons() retains all unique transects (unique crosswalk_id / cs_id) - default inputs", {
  ...
  ext_dists <- hydrofabric3D::get_transect_extension_distances_to_polygons(
    transects = transects,
    polygons = polygons, 
    crosswalk_id = CROSSWALK_ID, 
    max_extension_distance = MAX_EXT_DIST,
...
testthat::test_that("get_transect_extension_distances_to_polygons() retains all unique transects (unique crosswalk_id / cs_id) - not all transects have a polygon to extend out to", {
...
testthat::test_that("get_transect_extension_distances_to_polygons() polygon is farther away than max extension distance so transect only goes to max_extension_distance", {
...
testthat::test_that("get_transect_extension_distances_to_polygons() max extension distance is long enough that transects reach edge of polygons ", {
...
testthat::test_that("get_transect_extension_distances_to_polygons() transects that are already longer than and reach outside of the edge of a polygon get extension distance of 0", {
...
testthat::test_that("get_transect_extension_distances_to_polygons() transects intersect with 2 overlapping polygons (i.e. 2 layered polygons, 1 entirely encompassing the other, both fully encompass the transect lines)", {
  ...
  small_ext_dists <- hydrofabric3D::get_transect_extension_distances_to_polygons(
    transects    = transects,
  ...
  all_ext_dists <- hydrofabric3D::get_transect_extension_distances_to_polygons(
    transects    = transects,
    polygons     =  buffed_flowlines, 
    crosswalk_id = CROSSWALK_ID, 
    max_extension_distance = MAX_EXT_DIST,
...
testthat::test_that("get_transect_extension_distances_to_polygons() transects intersect with 2 overlapping polygons (i.e. 2 layered polygons, 1 entirely encompassing the other, neither encompass the transect lines) should result in 0 extension distance", {
...
testthat::test_that("get_transect_extension_distances_to_polygons() transects intersect with 2 overlapping polygons (i.e. 2 layered polygons, 1 entirely encompassing the other, 1 polygon fully encompasses the transect lines, the other polygon does NOT, and is thus shorter than the transect lines) should result in transect lines getting extended to the bigger of the overlayed polygons", {
